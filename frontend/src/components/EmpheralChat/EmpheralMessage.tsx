...
export default function EmpheralMessage({ message }: { message: IncomingData | OutgoingData }) {
  ...
  return (
    <div className="text-[#0e0814]">
      {type === "user-message" ? (
        <div className="flex justify-end text-[#e2c3dc]">
              ...
              components={{
                ...
                code: (props: ComponentPropsWithoutRef<"code">) => {
                  ...
                  return isInline ? ( // inline notation
                    <code className="bg-secondary text-[#356b86] px-1 p-0.5 rounded text-sm break-words break-all whitespace-pre-wrap">
                      {children}
                    </code>
                  ) : ( // code block
                    (() => {
